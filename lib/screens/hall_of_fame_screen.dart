      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(children: [
            ...
            SizedBox(width: 8),
            Text('Hall of Fame',
                style: TextStyle(color: KratosColors.of(context).text, fontWeight: FontWeight.w800)),
          ]),
          actions: [
            IconButton(
          ...
          bottom: TabBar(
            ...
            unselectedLabelColor: KratosColors.of(context).muted,
    ...
    if (service.error != null && service.leaderboard.isEmpty) {
      return Center(child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Icon(Icons.wifi_off, color: KratosColors.of(context).muted, size: 48),
          const SizedBox(height: 16),
          Text(service.error!,
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('Best difficulty submissions from Kratos users',
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(name, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900,
                color: KratosColors.of(context).text)),
            if (model.isNotEmpty)
              Text(model, style: TextStyle(fontSize: 12, color: KratosColors.of(context).muted)),
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Text('best difficulty',
                style: TextStyle(fontSize: 9, color: KratosColors.of(context).muted, letterSpacing: 0.5)),
          ]),
        ]),
      ]),
    );
...
class _RankCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: rank == 1 ? color.withOpacity(0.06) : KratosColors.of(context).surface,
        borderRadius: BorderRadius.circular(14),
        border: Border.all(
          color: rank <= 3 ? color.withOpacity(0.3) : KratosColors.of(context).line,
          width: rank == 1 ? 1.5 : 1),
      ),
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(name, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700,
              color: KratosColors.of(context).text), overflow: TextOverflow.ellipsis),
          if (model.isNotEmpty)
            Text(model, style: TextStyle(fontSize: 11, color: KratosColors.of(context).muted),
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
          Text(diff, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900,
              color: color, fontFamily: 'Courier')),
          Text(_fmtDate(achievedAt),
              style: TextStyle(fontSize: 10, color: KratosColors.of(context).muted)),
        ]),
      ]),
    );
  }
...
class _RankBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 28, height: 28,
      decoration: BoxDecoration(color: KratosColors.of(context).bg,
          borderRadius: BorderRadius.circular(8),
          border: Border.all(color: KratosColors.of(context).line)),
      alignment: Alignment.center,
      child: Text('$rank', style: TextStyle(fontSize: 12,
          fontWeight: FontWeight.w800, color: KratosColors.of(context).muted, fontFamily: 'Courier')),
    );
  }
}
...
class _InfoNote extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(color: KratosColors.of(context).surface,
        borderRadius: BorderRadius.circular(10),
        border: Border.all(color: KratosColors.of(context).line)),
    child: Text(text, style: TextStyle(
        fontSize: 12, color: KratosColors.of(context).muted, height: 1.5)),
  );
}
    ...
    child: Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(
          ...
          textAlign: TextAlign.center,
          style: TextStyle(fontSize: 14, color: KratosColors.of(context).muted, height: 1.5),
        ),
      ]),
    ),
  );
...
Color _diffColor(double v) {
  ...
  if (v >= 1e9)  return const Color(0xFF00E676);
