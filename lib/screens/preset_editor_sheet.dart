...
class PresetEditorSheet extends StatefulWidget {
  ...
  final bool isNew;
  const PresetEditorSheet({super.key, required this.preset, this.isNew = false});
  @override
...
class _PresetEditorSheetState extends State<PresetEditorSheet> {
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            Row(children: [
              Expanded(child: Text(
                widget.isNew ? 'New Pool Preset' : 'Edit Preset',
            ...
            const SizedBox(height: 6),
            Row(children: [
              Expanded(child: _field(_host, 'solo.mineshop.eu', kc, color,
                ...
                final v = await showDialog<String>(
                  ...
                  builder: (ctx) {
                    ...
                    return AlertDialog(
                      ...
                      title: Text('Paste stratum URL', style: TextStyle(color: kc.text)),
                      content: TextField(
            ...
            // Format chips
            Wrap(spacing: 6, children: WorkerFormat.values.map((f) {
              final sel = _format == f;
              return GestureDetector(
                ...
                child: Chip(
                  ...
                  side: BorderSide(color: sel ? color.withOpacity(0.4) : kc.line),
            ...
            SizedBox(
              ...
              child: FilledButton(
                ...
                onPressed: _host.text.trim().isEmpty ||
                    _worker.text.trim().isEmpty ? null : _save,
                child: Text(
  ...
  Widget _field(TextEditingController c, String hint, KratosPalette kc, Color accent,
